...
class SearchSimilarityInput():
    query: str = Field(description="The search query used")

class SearchSimilarityOutput():
    similar_documents: list = Field(description="list of ids")

class SearchSimilarityTool():
    name = "search"
    description = "Tools for perfoming similarity search using embeddings"
    args_schema = SearchSimilarityInput
    result_schema = SearchSimilarityOutput
